...
import { CalendarDays, MapPin, Clock, Users, ImageOff } from "lucide-react"
            ...
            >
              ...
              <div className="relative w-full aspect-[4/3] overflow-hidden bg-secondary/40">
                {event.image ? (
                  ...
                  // Placeholder si no hay afiche aún
              ...
              <div className="flex flex-col flex-1 p-6">
                <h3 className="mb-4 text-lg font-semibold text-foreground leading-snug">
                  {event.title}
                </h3>
