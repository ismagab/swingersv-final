...
export function EventsSection({ events }: { events: Event[] }) {
  ...
  return (
    <section id="events" className="relative py-16 sm:py-20 lg:py-24">
      ...
      <Reveal className="mx-auto max-w-7xl px-6">
        ...
        {upcomingEvents.length > 0 ? (
          ...
          <div className="rounded-xl border border-border/40 bg-secondary/30 p-10 text-center text-sm text-muted-foreground">
            Muy pronto anunciaremos nuestras próximas fiestas. ¡Síguenos en X para no perderte la fecha!
          </div>
        )}

        <div className="mt-10 mx-auto flex max-w-2xl flex-col items-center gap-3 rounded-xl border border-border/40 bg-secondary/50 p-6 text-center">
          <p className="text-sm text-muted-foreground">
            Síguenos en X para enterarte primero de fechas, cupos y detalles de cada fiesta.
          </p>
          <a
            href="https://x.com/Swinger_sv"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 rounded-lg bg-foreground px-5 py-3 text-xs font-bold uppercase tracking-wider text-background transition-all hover:opacity-90"
          >
        ...
        <div className="mt-6 mx-auto max-w-2xl rounded-xl border border-border/40 bg-secondary/50 p-5 text-center">
