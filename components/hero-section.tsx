    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 py-24 text-center">
        ...
        <p className="mx-auto mb-10 max-w-2xl text-base leading-relaxed text-muted-foreground sm:text-lg">
          Si estás cansado de hablar con perfiles falsos… Bienvenido a un lugar
          donde las parejas sí se conocen cara a cara. No importa tu estatus ni
          tu físico, queremos parejas reales como tú. Creamos puntos de encuentro
          para que conozcan parejas salvadoreñas y extranjeros que nos visitan.
        </p>
