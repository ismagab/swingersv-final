    ...
    <footer className="border-t border-border/40 bg-card">
      <div className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="mt-10 border-t border-border/40 pt-8">
          ...
          {/* Crédito Vortex */}
          <div className="mt-6 flex justify-center border-t border-border/30 pt-6 sm:justify-start">
            <a
              href="https://www.vortexsv.com"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-xs text-muted-foreground transition-colors hover:text-primary"
            >
              Sitio web creado por
              <span className="font-bold tracking-tight" style={{ color: "#7C3AED" }}>
                Vortex
              </span>
            </a>
          </div>
