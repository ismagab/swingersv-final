          ...
          <div className="flex flex-col gap-10 text-sm leading-relaxed text-muted-foreground">
            ...
            <div>
              ...
              <p>
                ...
                para medir el rendimiento y uso del Sitio. Estos datos son anónimos y
                estadísticos, y no permiten identificar a usuarios individuales. No se
                utilizan cookies para publicidad ni para compartir información con
                terceros.
              </p>
            </div>
